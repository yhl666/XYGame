...
function t.request_pvp_v1(ctx, msg, cb)
    ...
    remote.request("services.battle", "request_pvp_v1", msg, function(msg1)
        if msg == "" then
        ...
        if json.decode(msg5)["ret"] == "ok" then
            ...
            remote.request("services.user", "query_user", msg1, function(msg5)
                ...
                if json.decode(msg5)["ret"] == "ok" then
                    ...
                    remote.request("services.battle", "request_pvp_v2", msg, function(msg5)
                        if msg == "tiemout" then
                            cb("ret:error,msg:timeout,");
                            return;
                        end
...
function t.request_verify(ctx, msg, cb)
    ...
    remote.request("services.battle", "request_verify_read", msg1, function(msg2)
